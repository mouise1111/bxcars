        ...
        <tbody>
            ...
            <tr class="bg-yellow-500 border-b">
                ...
                <td class="px-6 py-2 text-center">
                    @if($car->photo)
                    <img class="w-20 h-20 object-cover mx-auto" src="{{ Storage::url($car->photo) }}" alt="Car Image">
                    @endif
                </td>
                <td class="px-6 py-2 text-center">
    ...
    <div class="relative top-20 mx-auto p-5 border w-96 shadow-lg rounded-md bg-gray-800">
        <div class="mt-3 text-center">
            ...
            <form id="editForm" method="POST" action="" enctype="multipart/form-data">
                ...
                <input type="number" id="priceCaution" name="price_caution" class="mt-2 border p-2 w-full" step="0.01"
                    required>
